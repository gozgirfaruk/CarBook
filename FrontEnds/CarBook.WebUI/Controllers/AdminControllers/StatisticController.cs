...
namespace CarBook.WebUI.Controllers.AdminControllers
{
    public class StatisticController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //#region İstatistik1
            //var responseMessage = await client.GetAsync("https://localhost:7059/api/Statistics/CarCount");
            ...
            #region İstatistik6
            var responseMessage6 = await client.GetAsync("https://localhost:7059/api/Statistics/GetAvgRentPriceForDaily");
            ...
            #region İstatistik7
            var responseMessage7 = await client.GetAsync("https://localhost:7059/api/Statistics/GetAvgRentPriceForWeekly");
            ...
            #region İstatistik8
            var responseMessage8 = await client.GetAsync("https://localhost:7059/api/Statistics/GetAvgRentPriceForMonthly");
            ...
            #region İstatistik9
            var responseMessage9 = await client.GetAsync("https://localhost:7059/api/Statistics/GetCarCountByTranmissionIsAuto");
            ...
            #region İstatistik10
            var responseMessage10 = await client.GetAsync("https://localhost:7059/api/Statistics/GetBrandNameByMaxCar");
            ...
            #region İstatistik11
            var responseMessage11 = await client.GetAsync("https://localhost:7059/api/Statistics/GetBlogTitleByMaxBlogComment");
            ...
            #region İstatistik12
            var responseMessage12 = await client.GetAsync("https://localhost:7059/api/Statistics/GetCarCountByKmSmallerThen1000");
            ...
            #region İstatistik13
            var responseMessage13 = await client.GetAsync("https://localhost:7059/api/Statistics/GetCarCountByFuelGasolineOrDiesel");
            ...
            #region İstatistik14
            var responseMessage14 = await client.GetAsync("https://localhost:7059/api/Statistics/GetCarCountByFuelElectric");
            ...
            #region İstatistik15
            var responseMessage15 = await client.GetAsync("https://localhost:7059/api/Statistics/GetCarBrandAndModelByRentPriceDailyMax");
            ...
            #region İstatistik16
            var responseMessage16 = await client.GetAsync("https://localhost:7059/api/Statistics/GetCarBrandAndModelByRentPriceDailyMin");
